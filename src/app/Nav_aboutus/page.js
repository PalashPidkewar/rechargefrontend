  ...
  return (
    <main className="font-sans text-gray-900 bg-white">
      ...
      <section className="py-12 px-2 max-w-7xl mx-auto">
        ...
        <div className="pt-0 text-left pl-2">
          <motion.h2
            ...
            className="text-3xl sm:text-4xl lg:text-4xl font-bold fonty text-[#0078AE] mb-6 inline-block"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-10 gap-8 items-center">
          ...
          <div className="md:col-span-7 fonty px-5">
            <p className="text-base sm:text-lg text-gray-600 leading-relaxed mb-6  tracking-wide text-justify">
            ...
            <p className="text-base sm:text-lg text-gray-600 leading-relaxed  tracking-wide text-justify">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('brandpatnerimg/our-brand-bg.webp')",
        }}
      >
