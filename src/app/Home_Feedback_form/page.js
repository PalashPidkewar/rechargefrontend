...
export default function FeedbackForm() {
  ...
  return (
    ...
    >
      {/* Left Section */}
      <div className="relative flex-1 text-center md:text-left bg-white/30 p-4 sm:p-6 md:p-8 rounded-lg lg:p-11 shadow-lg shadow-indigo-900/50 overflow-hidden">
