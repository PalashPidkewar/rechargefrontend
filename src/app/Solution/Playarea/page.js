...
// const images = [
//   { src: "/Playarea/play1.png", alt: "Advanced Fuel Solution Unit" },
//   { src: "/Playarea/play2.png", alt: "Close-up of Input Panel" },
//   { src: "/Playarea/play3.png", alt: "Internal Components View" },
//   { src: "/Playarea/play4.jpg", alt: "System in Action/Installation" },
// ];

// const Playareasolution = () => {
//   const [mainImageIndex, setMainImageIndex] = useState(0);

//   const mainImage = images[mainImageIndex];

//   return (
//     <div className="container mx-auto p-4 md:p-10 bg-white dark:bg-gray-900 shadow-2xl rounded-2xl border border-gray-100 dark:border-gray-700">
...
//         <div className="w-2/3 relative rounded-xl overflow-hidden border-4 border-gray-200 dark:border-gray-700 shadow-2xl flex items-center justify-center bg-gray-50 dark:bg-gray-800">
...
// export default Playareasolution 
"use client";

import React, { useState } from "react";
import Head from "next/head"; // SEO के लिए
import { SiGoogledisplayandvideo360 } from "react-icons/si";
const images = [
  { src: "/Playarea/play1.png", alt: "Play Area with Advanced Fuel Solution Unit" },
  { src: "/Playarea/play2.png", alt: "Close-up of Play Area Input Panel" },
  { src: "/Playarea/play3.png", alt: "Internal Components View of Play Area Solution" },
  { src: "/Playarea/play4.jpg", alt: "Play Area System in Action / Installation" },
];
...
const Playareasolution = () => {
  ...
  return (
    <>
      {/* --- SEO Head --- */}
      <Head>
        <title>Play Area Solution | Innovative Playground & Fuel Solutions</title>
        <meta
          name="description"
          content="Explore our Play Area Solution with advanced features and innovative design. View detailed images, internal components, and installation in action."
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Play Area Solution | Innovative Playground & Fuel Solutions" />
        <meta
          property="og:description"
          content="Discover our innovative Play Area Solution with detailed views and installation insights."
        />
        <meta property="og:type" content="website" />
        <meta property="og:image" content={mainImage.src} />
      </Head>
