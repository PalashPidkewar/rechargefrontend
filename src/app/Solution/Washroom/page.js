...
const images = [
  { src: "/Washroom/washroom1.png", alt: "Modern Washroom Unit Design" },
  { src: "/Washroom/washroom2.png", alt: "Close-up of Input Panel and Controls" },
  { src: "/Washroom/washroom3.png", alt: "Internal Components/Water System View" },
  { src: "/Washroom/washroom 4.png", alt: "Complete System Installation View" },
];
...
>
  ...
  <h1 className="text-sm mt-1">Video</h1>
        ...
        <p className="mt-2 text-xl text-gray-500 dark:text-gray-400">
          Explore detailed views of our innovative washroom product.
        </p>
      </div>
          ...
          {images.map((img, index) => (
            <button
              ...
              className={`
                ...
                ${
                  mainImageIndex === index // <--- FIX IS HERE: Changed inwashroomsolutiondex to index
