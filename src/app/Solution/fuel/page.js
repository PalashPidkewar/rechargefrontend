...
const images = [
  { src: "/fuel/full4.png", alt: "Advanced Fuel Solution Unit" },
  { src: "/fuel/full1.png", alt: "Close-up of Input Panel" },
  { src: "/fuel/full2.png", alt: "Internal Components View" },
  { src: "/fuel/full3.png", alt: "System in Action/Installation" },
];
...
const Fuelsolution = () => {
  ...
  return (<>
    <div className="container mx-auto p-4 md:px-10 bg-white  shadow-2xl rounded-2xl border border-gray-100 dark:border-gray-300">
